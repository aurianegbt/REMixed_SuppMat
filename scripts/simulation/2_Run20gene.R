...
cat("Starting algorithm cv.remix...\n")
dir("outputs/simulationResults")
dir(paste0("outputs/simulationResults/simulationVaccinology_",Nbr_genes,"/"))

pathToResults = paste0("outputs/simulationResults/simulationVaccinology_",Nbr_genes,"/resREMIX_",Nb_rep,".RData")
...
resCV = cv.remix(project = project,
                 ...
                 alpha = list(alpha0=alpha0,
                              alpha1=setNames(paste0("alpha_1",1:Nbr_genes),
                                              paste0("yG",1:Nbr_genes))),
                 selfInit = TRUE,
                 eps1=10**(-2),
                 eps2=1,
                 nlambda=15)
...
save(resCV,res,file=paste0("outputs/simulationResults/simulationVaccinology_",Nbr_genes,"/resREMIX_",Nb_rep,".RData"))
