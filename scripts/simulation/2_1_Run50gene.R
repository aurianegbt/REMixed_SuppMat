## This scrip only to compute for lambda max in order to parallelize later on every point of the grid
# empty the memory
rm(list=ls())
...
pathToResults = paste0("outputs/simulationResults/simulationVaccinology_",Nbr_genes,"/resREMIX_0_",arr,".RData")
